...
class _ManageWorkersState extends State<ManageWorkers> {
  ...
  Future<void> _showAddWorkerDialog([Map<String, dynamic>? existingWorker]) async {
    final nameController = TextEditingController(text: existingWorker?['name'] ?? '');
    final emailController = TextEditingController(text: existingWorker?['email'] ?? '');
    final roleController = TextEditingController(text: existingWorker?['role'] ?? '');
    ...
    final result = await showDialog<bool>(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          title: Text(existingWorker != null ? 'Edit Worker' : 'Add New Worker'),
            ...
            child: Column(
              ...
              children: [
                ...
                SwitchListTile(
                  ...
                  subtitle: Text(isActive ? 'Currently working' : 'Inactive'),
                  value: isActive,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 16),
                            Text(
                              _searchQuery.isEmpty ? 'No workers added yet' : 'No workers found',
                            ...
                            ElevatedButton.icon(
                              ...
                              label: const Text('Add First Worker', style: TextStyle(color: Colors.white)),
                              style: ElevatedButton.styleFrom(backgroundColor: _whitbyBlue),
                            ),
                          ],
                        ),
                            ...
                            child: ListTile(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  ...
                                  if (worker['email']?.toString().isNotEmpty == true)
                                    Text(
                                      worker['email'],
                                      style: TextStyle(
                                        fontSize: 12,
      ...
      floatingActionButton: _filteredWorkers.isNotEmpty
